...
public class Controller {
    ...
    public Controller(ControllerType controllerType, int port, double triggerDeadzone) {
        ...
        XboxButtonMap.put(Buttons.leftTrigger, xboxController.leftTrigger(triggerDeadzone));
        XboxButtonMap.put(Buttons.rightTrigger, xboxController.rightTrigger(triggerDeadzone));
        ...
        PS5ButtonMap.put(Buttons.leftTrigger, ps5Controller.axisGreaterThan(PS4Controller.Axis.kL2.value, -1 + triggerDeadzone));
        PS5ButtonMap.put(Buttons.rightTrigger, ps5Controller.axisGreaterThan(PS4Controller.Axis.kR2.value, -1 + triggerDeadzone));
